...
export const todayTaipei = (offsetDays = 0) => new Intl.DateTimeFormat('en-CA', {
    timeZone: TZ,
    year: 'numeric',
    month: '2-digit',
    day: '2-digit',
...
export const weekdayLabel = (date) => ['日', '一', '二', '三', '四', '五', '六'][new Date(`${date}T00:00:00+08:00`).getDay()] ?? '';
